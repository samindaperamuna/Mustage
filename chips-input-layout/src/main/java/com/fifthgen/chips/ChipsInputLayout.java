...
public class ChipsInputLayout extends MaxHeightScrollView
    ...
    public OnChipClickListener getOnChipClickListener() {
        return mChipsAdapter.getChipClickListener();
    }

    public void setOnChipClickListener(OnChipClickListener chipClickListener) {
        if (mChipsAdapter != null) {
            mChipsAdapter.setChipClickListener(chipClickListener);
        }
    }
