...
public class ChipView extends FrameLayout implements ChipComponent {
    ...
    public void setChipOptions(ChipOptions options) {
        ...
        if (!options.mShowAvatar) {
            ...
            ConstraintLayout.LayoutParams lp = (ConstraintLayout.LayoutParams) mLabelView.getLayoutParams();
    ...
    public void inflateFromChip(Chip chip) {
        ...
        Drawable drawable = getResources().getDrawable(R.drawable.bg_chip_view).mutate();
        drawable.setColorFilter(Color.parseColor(mChip.getColor()), PorterDuff.Mode.SRC_ATOP);
